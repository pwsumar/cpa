...
function twentyseventeen_scripts() {
	...
	wp_enqueue_style( 'main-css', get_stylesheet_directory_uri() . '/styles/main.css?v=1.0.4' );
	...
	wp_enqueue_script( 'scripts-main', get_stylesheet_directory_uri() . '/scripts/min/main-min.js?v=1.0.0', array(), false, true );
...
function my_custom_post_port() {
	$labels = array(
			'name'               => _x( 'Port', 'post type general name' ),
			'singular_name'      => _x( 'Port', 'post type singular name' ),
			'add_new'            => _x( 'Add New', 'Port' ),
			'add_new_item'       => __( 'Add New Port' ),
			'edit_item'          => __( 'Edit Port' ),
			'new_item'           => __( 'New Port' ),
			'all_items'          => __( 'All Port' ),
			'view_item'          => __( 'View Port' ),
			'search_items'       => __( 'Search Port' ),
			'not_found'          => __( 'No Port found' ),
			'not_found_in_trash' => __( 'No Port found in the Trash' ),
			'parent_item_colon'  => '',
			'menu_name'          => 'Port'
	);
	$args = array(
			'labels'        => $labels,
			'description'   => 'Holds our Port and Port specific data',
			'public'        => true,
			'menu_position' => 5,
...
add_action( 'init', 'my_custom_post_port' );
